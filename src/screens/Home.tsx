...
export function Home({ onLayout }: Props) {
  ...
  return (
    <View style={{  height:'100%',
     ...
     backgroundColor: "#000" }} onLayout={onLayout}>
      
      <Header />
      <TouchableOpacity style={{marginBottom:20, width: '95%', alignItems:'center', 
      ...
      {isModalOpen && (
        <FavoriteCharModal isModalOpen={isModalOpen} setIsModalOpen={setIsModalOpen} />
      )}
    </View>
  );
}
